...
// defines all the accounts needed for deposit instruction
#[derive(Accounts)]
...
pub fn process_withdraw(
    ...
    // Check which token type and get corresponding deposit amount
